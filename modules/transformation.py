...
#             layers.MaxPool2D(pool_size=2, padding='same'),  # batch_size x 64 x I_height/2 x I_width/2
#
#             layers.Conv2D(128, kernel_size=3, strides=1, padding='same', use_bias=False),
#             layers.BatchNormalization(), layers.ReLU(),
#             layers.MaxPool2D(pool_size=2, padding='same'),  # batch_size x 128 x I_height/4 x I_width/4
#
#             layers.Conv2D(256, kernel_size=3, strides=1, padding='same', use_bias=False),
#             layers.BatchNormalization(), layers.ReLU(),
#             layers.MaxPool2D(pool_size=2, padding='same'),  # batch_size x 256 x I_height/8 x I_width/8
#
#             layers.Conv2D(512, kernel_size=3, strides=1, padding='same', use_bias=False),
#             layers.BatchNormalization(), layers.ReLU(),
#             # TODO: layers.AdaptiveAvgPool2D(1)  # batch_size x 512
#             layers.AvgPool2D
#         )
#
#         # self.localization_fc1 = Sequential(nn.Linear(512, 256), nn.ReLU(True))
#         self.localization_fc1 = layers.Dense(units=256, activation='relu')
#         self.localization_fc2 = layers.Dense(units=self.F * 2)
#
